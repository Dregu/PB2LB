...
fs.readdir('data', function(err, files) {
	for(file of files) {
		...
		let any = 'Poly Bridge 2 - '+level.toUpperCase()+' any% leaderboard, updated '+new Date().toISOString()+"\n\n";
		let unb = 'Poly Bridge 2 - '+level.toUpperCase()+' unbreaking leaderboard, updated '+new Date().toISOString()+"\n\n";
		console.log(level);
